...
var CategoriesService = (function (_super) {
    ...
    function CategoriesService(http) {
        ...
        _this.categoriesUrl = '/services/api/category'; // URL to web api
        return _this;
    }
    ...
    CategoriesService.prototype.create = function (name) {
    ...
    CategoriesService.prototype.edit = function (id, name) {
        var url = this.categoriesUrl + "/" + id + "/rename/" + name;
    ...
    CategoriesService.prototype.union = function (name, categoryIds) {
        var url = this.categoriesUrl + "/union";
