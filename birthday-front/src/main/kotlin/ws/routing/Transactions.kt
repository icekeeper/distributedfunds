...
import birthday.service.BirthdayTransactionOperations
...
fun Route.transaction(transactionOperations: BirthdayTransactionOperations) {
    ...
    route("user/fund/{fundId}/transaction") {
        authorized {
            ...
            post<CreateRedistributionTransactionRequest>("redistribution") { (fundId, toUserId, description, amount) ->
                ...
                call.respond(redistributionTransactionToDto(transaction, userId))
            }
            ...
            post<CreateGiftTransactionRequest>("gift") { (fundId, receiverId, description, price) ->
                ...
                call.respond(giftTransactionToDto(transaction, userId))
            }
