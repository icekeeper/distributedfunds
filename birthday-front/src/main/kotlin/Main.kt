import birthday.service.CoreBasedBirthdayTransactionOperations
import birthday.service.error.BirthdayException
import core.service.error.OperationsException
import core.service.impl.StorageBackedFundOperations
import core.service.impl.StorageBackedUserOperations
import core.storage.dao.initDao
import core.storage.exposed.ExposedFundRepository
import core.storage.exposed.ExposedTransactionRepository
    ...
    val server = embeddedServer(Jetty, 8080) {
        routing {
            ...
            route("/api/front") {
                ...
                user(userOperations)
                fund(fundOperations)
                transaction(birthdayTransactionOperations)
            }
        }
